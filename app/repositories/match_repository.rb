class MatchRepository
  ...
  def self.all
    [
     ...
     Match.new(opponent: "Brunswick", date: Date.parse("2014/4/10"), time: "7:00pm", location: "Brunswick High School", address: "3227 Graham Rd, Stow, OH 44224"),
     ...
     Match.new(opponent: "Brecksville", date: Date.parse("2014/5/2"), time: "5:30pm", location: "Brecksville High School", address: "6376 Mill Rd, Cleveland, OH 44147", notes: "Tri match"),
     Match.new(opponent: "NDCL", date: Date.parse("2014/5/2"), time: "6:30pm", location: "Brecksville High School", address: "6376 Mill Rd, Cleveland, OH 44147", notes: "Tri match"),
