class MatchRepository
  ...
  def self.all
    ...
    #  Match.new(opponent: "Open Gym", date: Date.parse("2019/02/04"), time: "7:00PM - 8:30PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: true ),
    #  Match.new(opponent: "Open Gym", date: Date.parse("2019/02/12"), time: "7:00PM - 8:30PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: true ),
    #  Match.new(opponent: "Open Gym", date: Date.parse("2019/02/14"), time: "7:00PM - 8:30PM", location: "Stow High School (LG)", address: "3227 Graham Rd, Stow, OH 44224", tournament: true ),
    #  Match.new(opponent: "Open Gym", date: Date.parse("2019/02/19"), time: "5:00PM - 6:30PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: true ),
    ...
    #  Match.new(opponent: "St Joseph", date: Date.parse("2019/03/26"), time: "7:00PM", location: "Villa Angela St Joseph", address: "18491 Lakeshore Blvd, Cleveland, OH 44119", tournament: false),
    #  Match.new(opponent: "Jackson", date: Date.parse("2019/04/02"), time: "7:00PM", location: "Jackson High School", address: "7600 Fulton Rd NW, Massillon, OH", tournament: false),
    #  Match.new(opponent: "Kent", date: Date.parse("2019/04/04"), time: "7:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: false ),
    #  Match.new(opponent: "Olentangy Orange (Tri)", date: Date.parse("2019/04/06"), time: "10:00AM", location: "Olentangy Orange High School", address: "2840 East Orange Rd, Lewis Center, OH 43035", tournament: false ),
    #  Match.new(opponent: "Brecksville", date: Date.parse("2019/04/09"), time: "7:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: false ),
    #  Match.new(opponent: "Medina", date: Date.parse("2019/04/11"), time: "7:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: false ),
    #  Match.new(opponent: "Spike for Tykes", date: Date.parse("2019/04/13"), time: "10:00AM", location: "University of Mount Union", address: "1972 Clark Ave, Alliance, OH 44601", tournament: true ),
    #  Match.new(opponent: "St Edwards", date: Date.parse("2019/04/16"), time: "7:00pm", location: "St Edwards High School", address: "13500 Detroit Ave, Lakewood, OH 44107"),
    #  Match.new(opponent: "Hudson", date: Date.parse("2019/04/17"), time: "7:00PM", location: "Hudson High School", address: "2500 Hudson Aurora Rd, Hudson, OH 44236", tournament: false ),
    #  Match.new(opponent: "Walsh Jesuit", date: Date.parse("2019/04/22"), time: "7:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: false ),
    #  Match.new(opponent: "Brunswick", date: Date.parse("2019/04/23"), time: "7:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: false ),
    #  Match.new(opponent: "Jackson", date: Date.parse("2019/04/25"), time: "7:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: false ),
    #  Match.new(opponent: "Archbishop Hoban", date: Date.parse("2019/04/30"), time: "7:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: false ),
    #  Match.new(opponent: "Kent", date: Date.parse("2019/05/02"), time: "7:00PM", location: "Stanton Middle School", address: "1175 Hudson Rd, Kent, OH 44240"),
    #  Match.new(opponent: "Pickerington North (Quad)", date: Date.parse("2019/05/04"), time: "10:00AM", location: "Pickerington North HS", address: "7800 Refugee Rd, Pickerington, OH 43147", tournament: true ),
    #  Match.new(opponent: "Brecksville", date: Date.parse("2019/05/07"), time: "7:00pm", location: "Brecksville High School", address: "6376 Mill Rd, Cleveland, OH 44147", tournament: false),
    #  Match.new(opponent: "Hudson (Senior Night)", date: Date.parse("2019/5/10"), time: "7:00pm", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224"),
    #  Match.new(opponent: "Alumni Scrimmage", date: Date.parse("2019/05/16"), time: "6:00pm", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224")

    Match.new(opponent: "Open Gym", date: Date.parse("2020/01/27"), time: "7:30PM - 9:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: true ),
    Match.new(opponent: "Open Gym", date: Date.parse("2020/02/10"), time: "7:30PM - 9:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: true ),
    Match.new(opponent: "Open Gym", date: Date.parse("2020/02/12"), time: "6:00PM - 7:30PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: true ),
    Match.new(opponent: "Open Gym", date: Date.parse("2020/02/19"), time: "7:30PM - 9:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: true ),
    Match.new(opponent: "Open Gym", date: Date.parse("2020/02/24"), time: "6:00PM - 7:30PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: true ),
    Match.new(opponent: "Open Gym", date: Date.parse("2020/02/26"), time: "7:30PM - 9:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: true ),
    ]
  end
end
