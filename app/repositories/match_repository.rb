class MatchRepository
  ...
  def self.all
    [
     ...
     # Match.new(opponent: "VASJ (Tri)", date: Date.parse("2016/04/09"), time: "2:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: true ),
     # Match.new(opponent: "Brunswick (Tri)", date: Date.parse("2016/04/09"), time: "4:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: true ),
     ...
     # Match.new(opponent: "Hoban Scrimmage", date: Date.parse("2017/03/14"), time: "7:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: false ),
     # Match.new(opponent: "Super Scrimmage (V)", date: Date.parse("2017/3/18"), time: "9:00am", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: true ),
     # Match.new(opponent: "Hudson Scrimmage", date: Date.parse("2017/03/21"), time: "7:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: false ),
     # Match.new(opponent: "Pickerington North (Tri)", date: Date.parse("2017/03/25"), time: "11:00AM", location: "Pickerington North HS", address: "7800 Refugee Rd, Pickerington, OH 43147", tournament: true ),
     ...
     # Match.new(opponent: "Kent", date: Date.parse("2017/04/13"), time: "7:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: false ),
     # Match.new(opponent: "Hudson", date: Date.parse("2017/4/18"), time: "7:00pm", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224"),
     # Match.new(opponent: "Jackson", date: Date.parse("2017/4/20"), time: "7:00pm", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224"),
     # Match.new(opponent: "Brunswick", date: Date.parse("2017/4/25"), time: "7:00pm", location: "Visintainer Middle School", address: "1459 Pearl Road, Brunswick, OH 44212"),
     ...
     Match.new(opponent: "Garaway", date: Date.parse("2018/04/05"), time: "7:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: false ),
     ...
     # Match.new(opponent: "St. VM", date: Date.parse("2018/04/12"), time: "7:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: false ),
     Match.new(opponent: "Spike for Tykes", date: Date.parse("2018/04/14"), time: "8:00AM", location: "Hiram College", address: "Hiram, OH", tournament: true ),
     Match.new(opponent: "Hoban", date: Date.parse("2018/04/17"), time: "7:00PM", location: "Archbishop Hoban", address: "1 Holy Cross Blvd, Akron, OH 44306"),
     Match.new(opponent: "Polar Bear Bash", date: Date.parse("2018/4/21"), time: "9:00AM", location: "Jackson High School", address: "7600 Fulton Rd NW, Massillon, OH", tournament: true),
     Match.new(opponent: "St. Ignatius", date: Date.parse("2018/04/24"), time: "7:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: false ),
     Match.new(opponent: "Kent", date: Date.parse("2018/04/26"), time: "7:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: false ),
     Match.new(opponent: "Hudson", date: Date.parse("2018/04/27"), time: "7:00PM", location: "Hudson High School", address: "2500 Hudson Aurora Rd, Hudson, OH 44236", tournament: false ),
     Match.new(opponent: "Jackson", date: Date.parse("2018/05/01"), time: "9:00AM", location: "Jackson High School", address: "7600 Fulton Rd NW, Massillon, OH", tournament: false),
     Match.new(opponent: "Gahanna Lincoln (Tri)", date: Date.parse("2018/05/05"), time: "10:00AM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: true ),
     Match.new(opponent: "Brecksville", date: Date.parse("2018/05/08"), time: "7:00PM", location: "Stow High School", address: "3227 Graham Rd, Stow, OH 44224", tournament: false ),
